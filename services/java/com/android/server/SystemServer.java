...
import com.slsi.sec.android.HdmiService;			//hdc 20141111;
...
class ServerThread {
    ...
    //private HdmiService mHdmiService;	//hdc 20141111;
    public HdmiService mnHdmiService;	//hdc 20141111;
...
Slog.i(TAG,"hdc HDMI Setting");	//hdc 20141111
/*
mHdmiService = new HdmiService();
Slog.i(TAG,"hdc HDMI Setting 0");
value = Settings.System.getInt(mContentResolver,Settings.System.TV_RESOLUTION,4809601);
Slog.i(TAG,"hdc HDMI Setting 1");
mHdmiService.setHdmiResolution(value);
Slog.i(TAG,"hdc HDMI Setting 2");
*/

/*
hdmisetting = SystemProperties.get("persist.sys.hdmi.tvmode","0");
value = Integer.parseInt(hdmisetting);	//hdc 20141113
mHdmiService.setHdmiMode(value);
Slog.i(TAG,"hdc HDMI Setting 0");

hdmisetting = SystemProperties.get("persist.sys.hdmi.resolution","720960");
value = Integer.parseInt(hdmisetting);	//hdc 20141113
mHdmiService.setHdmiResolution(value);
Slog.i(TAG,"hdc HDMI Setting 1");

hdmisetting = SystemProperties.get("persist.sys.hdmi.tvhdcp","0");
value = Integer.parseInt(hdmisetting);	//hdc 20141113
...
int value;	//hdc 20141113
String hdmisetting;
mnHdmiService = new HdmiService();
Slog.i(TAG,"hdc HDMI Setting begin");
hdmisetting = SystemProperties.get("persist.sys.hdmi.tvmode","0");
value = Integer.parseInt(hdmisetting);	//hdc 20141113
mnHdmiService.setHdmiMode(value);
Slog.i(TAG,"hdc HDMI Setting 0");

hdmisetting = SystemProperties.get("persist.sys.hdmi.resolution","720960");
value = Integer.parseInt(hdmisetting);	//hdc 20141113
mnHdmiService.setHdmiResolution(value);
Slog.i(TAG,"hdc HDMI Setting 1");

hdmisetting = SystemProperties.get("persist.sys.hdmi.tvhdcp","0");
value = Integer.parseInt(hdmisetting);	//hdc 20141113
mnHdmiService.setHdmiHdcp(value);
Slog.i(TAG,"hdc HDMI Setting 2");
