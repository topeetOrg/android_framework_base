...
public final class Settings {
	...
	/**
         * The tv out mode.//hdc 20141111
         */
        public static final String TV_MODE = "tv_mode";

	/**
         * The tv out resolution.//hdc 20141111
         */
	...
	/**
         * The hdmi top between 0 and 50.//hdc 20141110;
         */
        public static final String SCREEN_HDMITOP = "screen_hdmitop";

	/**
         * The hdmi left between 0 and 100.//hdc 20141110;
         */
        public static final String SCREEN_HDMILEFT = "screen_hdmileft";
