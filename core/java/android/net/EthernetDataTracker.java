...
public class EthernetDataTracker implements NetworkStateTracker {
    ...
    public static synchronized EthernetDataTracker getInstance() {
		...
		Log.e(TAG,"EthernetDataTracker.getInstance");
